...
| `04-ai-improvements.patch` | 3 檔 | 補完上游 README 標 **IN PROGRESS** 的兩個 AI 項目。**玩家特工**（依 IPA 自衛）：受威脅且未持槍會自動拔槍自衛、腎上腺素加快反應掃描、智力收緊射擊散布（只影響我方、不動敵方平衡）。**敵方特工**（追擊玩家）：目標失去視線/射程逾 4 秒即放棄追擊回預設，不再無限追。與中文化無關，可單獨回饋上游 |
